...
void CPU::decode() {
    switch (CPU::opcode) {
        ...
        case (0x02): CPU::LD(memory[R.bc], R_A);break;
        ...
        case (0x12): CPU::LD(memory[R.de], R_A);break;
        ...
        case (0x32): CPU::LDD(memory[R.hl], R_A);break;
        ...
        case (0x70): CPU::LD(memory[R.hl], R_B);break;
        case (0x71): CPU::LD(memory[R.hl], R_C);break;
        case (0x72): CPU::LD(memory[R.hl], R_D);break;
        case (0x73): CPU::LD(memory[R.hl], R_E);break;
        case (0x74): CPU::LD(memory[R.hl], R_H);break;
        case (0x75): CPU::LD(memory[R.hl], R_L);break;
        case (0x76): CPU::HALT();break;
        case (0x77): CPU::LD(memory[R.hl], R_A);break;         
        ...
        case (0xe0): CPU::LD(memory[0xFF00 + working_byte], R_A);break;
        case (0xe1): CPU::POP(R.hl);break;
        case (0xe2): CPU::LD(memory[0xFF00 + R_C], R_A);break;
        ...
        case (0xea): CPU::LD(memory[working_word], R_A);break;
